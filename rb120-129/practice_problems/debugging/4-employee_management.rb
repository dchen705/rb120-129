# Error raised was: n `==': private method `serial_number' called fo
# 'need to move to public the Employee#serial_number method oh no wait
# actually just need to move to protected - as its another instance of same class that needs
# access to serial_number in the Employee#== method
