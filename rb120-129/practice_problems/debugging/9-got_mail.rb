# I just included the Mailing in PostalService
# why was there no error that said noMethod error?
# If I remember correctly #send is a method more upstream in one of the ancestors which I think
# functions as a method that calls the method in the argument. ie:
# Kernel.send(puts) is puts.
class Mail
  def to_s
    "#{self.class}"
  end
