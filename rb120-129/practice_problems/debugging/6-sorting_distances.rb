# I don''t know if this is right but I believe that #sort works as
# an iterative method that passes in two elements of collections at a time
# calls <=> and uses the return value of <=> within the block to decide whether
# to keep position or flip the position of left and right side elements.

# So I wrote a custom <=> for Length class...
# It worked!
class Length
